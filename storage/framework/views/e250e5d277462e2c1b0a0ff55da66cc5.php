...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <textarea name="specifications" rows="3"
                          class="form-control"><?php echo e(old('specifications')); ?></textarea>
            </div>
            ...
            <div class="mb-3">
                <div class="form-check">
                    <input type="checkbox" name="availability" value="1"
                           ...
                           <?php echo e(old('availability') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\InnovShop\resources\views/admin/produits/create.blade.php ENDPATH**/ ?>