        ...
        <div class="card shadow-sm h-100">
            <div class="card-body">
                ...
                <p class="text-muted small mb-1">
                    Objectif mensuel : {{ number_format($objectifMensuel, 2) }} €
                </p>
                <div class="progress" style="height: 12px;">
                    <div class="progress-bar {{ $pourcentageBudget >= 100 ? 'bg-danger' : ($pourcentageBudget >= 75 ? 'bg-warning' : 'bg-success') }}"
                         ...
                         aria-valuenow="{{ $pourcentageBudget }}"
                         aria-valuemin="0"
                         aria-valuemax="100">
                    </div>
                </div>
        ...
        <div class="card shadow-sm h-100">
            <div class="card-body">
                ...
                <p class="text-muted small">
                    Soit une moyenne de
                    <strong>{{ number_format($depensesTrimestre / 3, 2) }} € / mois</strong>
                    sur le trimestre.
                </p>
                ...
                <p class="text-muted small">
                    Sur {{ $nombreCommandes }} commande(s) passée(s).
                </p>
            </div>
        </div>
    </div>
